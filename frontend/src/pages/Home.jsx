...
import { MdOutlineAddBox, MdOutlineDelete } from 'react-icons/md';  // Add + Delete  Icons
...
const Home = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get('https://bookstore-mern-backed.onrender.com/books')
            .then((response) => {
    ...
    return (
        <div className='p-4'>
            ...
            <div className='flex justify-between items-center'>
                <h1 className='text-4xl my-8 text-white'>Books List</h1>
