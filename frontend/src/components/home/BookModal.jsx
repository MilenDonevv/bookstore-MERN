...
// onClick={(event) => event.stopPropagation()} - we are blocking clicking because we will set it to click only under 2 conditions - click on close
// and click outside of the modal

const BookModal = ({ book, onClose }) => {   // onClose --> to close the modal
    return (
        <div className='fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center' onClick={onClose}>
            <div onClick={(event) => event.stopPropagation()} className='w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col relative'>
                ...
                <p className='mt-2'>Some aditional info</p>
                <p className='mt-4'>
